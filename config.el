...
(setq zig-executable "/home/aidenkoorsen/programs/zig/zig")
...
(add-to-list 'load-path "~/.doom.d/lang")
(require 'c3-ts-mode)
;; Odin OLS Setup
...
(with-eval-after-load 'lsp-mode
  ...
  (lsp-register-client
   (make-lsp-client :new-connection (lsp-stdio-connection "~/programs/ols/ols") ;; Adjust the path here
